...
const Creator = ({ creator }: CreatorProps) => {
  return (
    <section className="pt-36 mb-40">
      ...
      <div className="pt-12 grid sm:grid-cols-1 md:grid-cols-2  lg:grid-cols-3 gap-7 md:gap-0 place-items-center">
        <CreatorCard creator={creator} />
      </div>
      <Button
        className="mt-24 mx-auto md:w-[150px] md:h-[50px] rounded-4xl border-third border-1 text-third p-5"
        type="button"
        link=""
      >
        Explore More
