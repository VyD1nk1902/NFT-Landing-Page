...
const Banner = () => {
  ...
  return (
    <section className="pt-[100px] relative isolate">
      ...
      <div className="hero-wrapper mt-[180px] flex gap-[164px] items-center">
        <div className="max-w-[738px]">
          <h1 className="text-8xl leading-snug font-jura">Discover</h1>
          <h1 className="text-8xl leading-snug font-jura">Collect and Sell NFT.</h1>
          <p className="text-[30px] my-12">Explore on the world’s best largest NFT marketplace</p>
