  ...
  return (
    <div className="flex gap-0 md:gap-10 ">
      {cardInfo.map((card, index) => (
        <div key={index} className="relative md:w-[384px] md:h-[460px] w-[250px] h-[260px] px-4 pt-3 rounded-xl">
          <img className="absolute w-full h-full object-cover z-0" src={card.background} />
          <div className="relative z-10 flex flex-col justify-between h-full p-4 text-white">
            <div className="flex justify-between">
              ...
              <Button className="md:px-5 md:py-2 px-2 py-2 rounded-[20px] bg-third" link="" type="button">
                Place Bid
              </Button>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <span className="text-[#789EAC] text-base md:text-xl">{card.creator}</span>
              </div>
